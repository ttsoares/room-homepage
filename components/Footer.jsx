...
const Footer = () => {
  return (
    <div className="h-fit md:h-[33%] w-full flex flex-col md:flex-row">
      <div className="w-full md:w-[30%] h-96 bg-img_dark bg-cover bg-no-repeat bg-center"></div>
      ...
      <div className="w-full md:w-[30%] h-96 bg-img_light bg-cover bg-no-repeat bg-center"></div>
    </div>
  );
};
